    ...
    if 'username' in request.POST and 'password' in request.POST:
        ...
        if user is not None:
            if user.is_active:
                ...
                error_msg = 'Sorry, your account has been disabled. <a href="mailto:timecard@iseinc.biz">Get in touch with us</a> and we\'ll help you sort this out!'
        else:
...
def process_forgot_password(request):
    ...
    try:
        ...
        msg = EmailMultiAlternatives('Your ' + settings.PROJECT_NAME + ' Password Has Been Reset', text_content,
